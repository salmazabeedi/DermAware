...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = dearmAwareFirebaseUserStream()
...
class _NavBarPageState extends State<NavBarPage> {
  String _currentPageName = 'HomePagee';
  ...
  Widget build(BuildContext context) {
    final tabs = {
      ...
      'HomePagee': const HomePageeWidget(),
    ...
    return Scaffold(
      ...
      bottomNavigationBar: FloatingNavbar(
        ...
        backgroundColor: const Color(0xFF73BCB2),
        selectedItemColor: const Color(0xFF73BCB2),
        ...
        items: [
          FloatingNavbarItem(
            customWidget: Column(
              ...
              children: [
                Icon(
                  currentIndex == 0 ? Icons.search : Icons.search,
